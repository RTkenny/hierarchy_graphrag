...
class RetrievalAugmentation:
    ...
    def add_documents(self, docs, persist_path=None):
        """
        ...
        self.tree = self.tree_builder.build_from_text(text=docs, persist_path=persist_path)

        self.retriever = TreeRetriever(self.tree_retriever_config, self.tree, persist_path=persist_path)
